...
import AvgElectricityPerDayByCitySingleCity from './singlecitycharts/AvgElectricityPerDayByCitySingleCity';
        ...
        <div style={{marginLeft:'50px',marginRight:'50px'}}>
            ...
            <Grid.Column computer={2} only="tablet computer" id="sidebar" >
                <Menu vertical borderless fluid text>
                    ...
                    <Menu.Item active as={Link} to='/console/sanjose'>San Jose</Menu.Item>
              ...
              <Grid.Row>
                  <Grid.Column width={4}>
                      <Segment className="chart-container">
                          ...
                          <DailyPowerGenerationSingleCity data={this.state.dailyPowerGeneration_data}/>
                      </Segment>
                  </Grid.Column>
                  <Grid.Column width={4}>
                      <Segment className="chart-container">
                          <div>Total Solar Panel Quantity In Previous Months</div>
                          <NumberOfSolarPanelsHistorySingleCity data={this.state.numberOfSolarPanelsHistorySingleCity_data}/>
                      </Segment>
                  </Grid.Column>
                  <Grid.Column width={4}>
                      <Segment className="chart-container">
                      <div>Avg Electricity Generated Per Month By City</div>
                      <AvgElectricityPerDayByCitySingleCity/>
                      </Segment>
                  </Grid.Column>
                  <Grid.Column width={4}>
                      <Segment className="chart-container">
                      <div>Avg Money Saved Per HH Per Month By City</div>
                      <AvgMoneySavedPerMonthByCitySingleCity/>
                      </Segment>
                  </Grid.Column>
              </Grid.Row>
